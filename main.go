...
*/
		...
		case (strings.Contains(msg,"!何切") ):
			...
			*/
			...
			"需要一摸進手牌後、或可選擇鳴牌的情境, 並遮擋他家手牌\n" +
			"和標記捨牌是否為摸打、若有鳴牌也講一下鳴牌的時間點\n" +
			"討論時通常會講自己的選擇, 再用對場況的解讀和一些基於客觀線索的判斷作補充說明\n" +
			"一般用0代表赤牌 m/p/s代表萬/筒/索\n\n" +
			"請試著把自己的想法說明清楚, 不懂時針對回應發問\n" +
			"儘量講得精確一點, 日麻變數太多, 籠統帶過別人可能無法瞭解你的意思by小劉\n" +
			"不被認同不代表被否定了, 有些時候可能沒有「標準答案」, 也可能因為環境而有不同經驗\n" +
