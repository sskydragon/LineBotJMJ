...
func determineReply(msg string) string{
	...
	switch {
		...
		case (strings.Contains(msg,"日麻") && strings.Contains(msg,"教學") && (strings.Contains(msg,"嗎") || strings.Contains(msg,"哪"))) :
			replyMsg = "http://jmj.tw 左上角有些教學可以看\n 請多利用喔喵~"
		case (strings.Contains(msg,"日麻") && strings.Contains(msg,"想") && strings.Contains(msg,"學") && strings.Contains(msg,"我")) :
			replyMsg = "http://jmj.tw 左上角有些教學可以看\n 請多利用喔喵~"
